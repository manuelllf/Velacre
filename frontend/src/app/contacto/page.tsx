    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
              ...
              <a href="mailto:privacidad@velacre.com" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">
        ...
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-700 flex flex-wrap gap-4 justify-center text-sm">
          ...
          <Link href="/terminos" className="text-indigo-600 dark:text-indigo-400 hover:underline">Términos y Condiciones</Link>
