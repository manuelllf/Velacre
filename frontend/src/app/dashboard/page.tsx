            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
              ...
              >
                <div>
                  ...
                  <span className="ml-2 text-xs text-slate-400 dark:text-slate-500">otra plataforma</span>
                </div>
              ...
              {manualOpen && (
                <div className="border-t border-slate-100 dark:border-slate-800 px-4 py-4">
                  <form onSubmit={handleGenerateManual} className="space-y-3">
                    <textarea
                      rows={4}
                      value={reviewText}
                      onChange={e => setReviewText(e.target.value)}
                      className="w-full px-3 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-white bg-white dark:bg-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
                    ...
                    >
                      {manualLoading ? (
                        ...
                        <><svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg> Generar 3 respuestas</>
                      )}
                    </button>
                  </form>
                  {manualError && (
